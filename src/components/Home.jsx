...
function Home() {
  ...
  const randomProfilePicture = useMemo(() => {
        ...
        <div className="section-container hero-container">
          <div className="hero-text">
            ...
            <div className="home-titles">
              {titles.map((title) => (
                <span key={title} className="title-tag">
                  {title}
                </span>
              ))}
            </div>
      ...
      <section className="tech-galaxy-section">
        <div className="section-container">
          ...
          <div className="tech-galaxy">
            <div className="tech-item item-py">
              <FaPython />
              <span className="tech-label">Python</span>
            </div>
            <div className="tech-item item-js">
              <FaJs />
              <span className="tech-label">JavaScript</span>
            </div>
            <div className="tech-item item-ts">
              <SiTypescript />
              <span className="tech-label">TypeScript</span>
            </div>
            <div className="tech-item item-react">
              <FaReact />
              <span className="tech-label">React</span>
            </div>
            <div className="tech-item item-nest">
              <SiNestjs />
              <span className="tech-label">NestJS</span>
            </div>
            <div className="tech-item item-dj">
              <SiDjango />
              <span className="tech-label">Django</span>
            </div>
            <div className="tech-item item-st">
              <SiStreamlit />
              <span className="tech-label">Streamlit</span>
            </div>
            <div className="tech-item item-docker">
              <FaDocker />
              <span className="tech-label">Docker</span>
            </div>
            <div className="tech-item item-git">
              <FaGitAlt />
              <span className="tech-label">Git</span>
            </div>
            <div className="tech-item item-pg">
              <SiPostgresql />
              <span className="tech-label">PostgreSQL</span>
            </div>
            <div className="tech-item item-supa">
              <SiSupabase />
              <span className="tech-label">Supabase</span>
            </div>
            <div className="tech-item item-jptr">
              <SiJupyter />
              <span className="tech-label">Jupyter</span>
            </div>
            <div className="tech-item item-numpy">
              <SiNumpy />
              <span className="tech-label">Numpy</span>
            </div>
            <div className="tech-item item-pandas">
              <SiPandas />
